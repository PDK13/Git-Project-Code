...
//Distance 0 mean not Cast (Even "INSIDE" other GameObject)
{
    ...
    private RaycastHit GetEye(int i_CastIndex)
        ...
        if (!m_XZ)
        {
            ...
            if (i_Cast == 1)
            {
                if (cs_Eye.GetLineCast_Check(
                    ...
                    transform.position + v3_OffPos + ClassVector.GetPosOnCircleXY(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, f_Distance), l_Barrier))
                {
                    //Always Hit Tarket on Line
                    return cs_Eye.GetLineCast_RaycastHit(
                        transform.position + v3_OffPos,
                        transform.position + v3_OffPos + ClassVector.GetPosOnCircleXY(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, f_Distance),
                        l_Barrier);
                }
            }
            //RayCast
            ...
            if (i_Cast == 2)
            {
                if (cs_Eye.GetRayCast_Vec_Check(
                    transform.position + v3_OffPos,
                    transform.position + v3_OffPos + ClassVector.GetPosOnCircleXY(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, f_Distance), f_Distance, l_Barrier))
                {
    ...
    if (m_XZ)
        {
            ...
            if (i_Cast == 1)
            {
                if (cs_Eye.GetLineCast_Check(
                    transform.position + v3_OffPos,
                    transform.position + v3_OffPos + ClassVector.GetPosOnCircleXZ(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, f_Distance), l_Barrier))
                {
                    //Always Hit Tarket if not have Barrier
                    return cs_Eye.GetLineCast_RaycastHit(
                        transform.position + v3_OffPos, transform.position + v3_OffPos + ClassVector.GetPosOnCircleXZ(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, f_Distance),
                        l_Barrier);
                }
            }
            //RayCast
            ...
            if (i_Cast == 2)
            {
                if (cs_Eye.GetRayCast_Vec_Check(
                    transform.position + v3_OffPos,
                    transform.position + v3_OffPos + ClassVector.GetPosOnCircleXZ(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, f_Distance), f_Distance, l_Barrier))
                {
                    //Always Hit Tarket if not have Barrier
                    return cs_Eye.GetRayCast_Vec_RaycastHit(
                        transform.position + v3_OffPos, transform.position + v3_OffPos + ClassVector.GetPosOnCircleXZ(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, f_Distance),
            ...
            if (i_Cast == 3)
            {
                if (cs_Eye.GetBoxCast_Vec_Check(
                    transform.position + v3_OffPos,
                    v3_Square,
                    transform.position + v3_OffPos + ClassVector.GetPosOnCircleXZ(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, f_Distance),
                    new Vector3(0, 0, 0),
                    f_Distance,
                    l_Barrier))
                {
    ...
    public List<float> GetList_Distance(int i_Minimize)
    ...
    public RaycastHit GetEye_Top(int i_Index)
    //Get EyeCast Top
    {
        return GetEye(i_Index * 2 - 1);
    }

    public bool GetEye_Top_Check(int i_Index)
    //Get Check EyeCast Top
    {
        return GetEye(i_Index * 2 - 1).collider != null;
    }

    public RaycastHit GetEye_Bot(int i_Index)
    //Get EyeCast Bot
    {
        return GetEye(i_Index * 2);
    }

    public bool GetEye_Bot_Check(int i_Index)
    //Get Check EyeCast Bot
    {
        return GetEye(i_Index * 2).collider != null;
    }
        ...
        if (!m_XZ)
        {
            ...
            if (i_Cast == 1)
            {
                    ...
                    transform.position + v3_OffPos + ClassVector.GetPosOnCircleXY(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, f_Distance), l_Barrier))
                {
                    ...
                    RaycastHit ray_Hit = cs_Eye.GetLineCast_RaycastHit(
                        transform.position + v3_OffPos, transform.position + v3_OffPos + ClassVector.GetPosOnCircleXY(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, f_Distance),
                        l_Barrier);
            ...
            if (i_Cast == 2)
            {
                    ...
                    l_Barrier))
                {
                    ...
                    Gizmos.DrawLine(
                        transform.position + v3_OffPos,
                        transform.position + v3_OffPos + ClassVector.GetPosOnCircleXY(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, ray_Hit.distance));
                }
                else
                {
                    Gizmos.color = Color.green;
        ...
        if (m_XZ)
        {
            ...
            if (i_Cast == 2)
            {
                    ...
                    transform.position + v3_OffPos + ClassVector.GetPosOnCircleXZ(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, f_Distance), f_Distance, l_Barrier))
                {
                    ...
                    Gizmos.DrawLine(
                        transform.position + v3_OffPos,
                        transform.position + v3_OffPos + ClassVector.GetPosOnCircleXZ(-cs_Rigid.GetRotation_XZ() + i_CastIndex * f_OffFan, ray_Hit.distance));
                }
                else
                {
                    Gizmos.color = Color.green;
