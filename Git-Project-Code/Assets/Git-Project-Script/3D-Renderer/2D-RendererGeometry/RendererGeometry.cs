...
{
    private RendererGeometryPoint cm_Point;
    ...
    private void Start()
    {
        cm_Point = GetComponent<RendererGeometryPoint>();
    ...
    private void Active_LineRenderer()
    {
        ...
        int m_PointCount = cm_Point.Receive_PointList().Count;
