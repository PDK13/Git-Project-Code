...
public class Iso_Object_Move : MonoBehaviour
{
    ...
    public void Set_Move(Vector3Int v3_Move_Dir, Vector3Int v3_Dir_High, bool b_GroundToStair)
    {
        ...
        GameObject cl_World_Check = cl_WorldManager.Get_Current_GameObject(this.g_World_StandOn.GetComponent<IsoBlock>().Get_PosOnMatrix_Current() + v3_Move_Dir + v3_Dir_High);
        ...
        this.g_World_StandOn = cl_World_Check;
    ...
    {
        return cl_WorldManager.Get_Current_GameObject(this.g_World_StandOn.GetComponent<IsoBlock>().Get_PosOnMatrix_Current() + v3_Move_Dir + v3_Dir_High);
    }
    ...
    private void Set_Move_Auto_X()
    {
        ...
        if (this.g_World_StandOn == null)
        {
            ...
            {
                cl_World_MoveTo = this.g_World_StandOn;
        ...
        else
        {
            ...
            f_Speed = this.f_Speed + this.g_World_StandOn.GetComponent<IsoBlockMove>().Get_Move_Active_Current().Get_Speed();
        }
