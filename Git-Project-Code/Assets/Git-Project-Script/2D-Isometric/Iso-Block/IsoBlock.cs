...
public class IsoBlock : MonoBehaviour
{
    ...
    private void Set_Pos_Transform()
    {
        ...
        Vector3 v3_Pos_Transform = Get_Pos_OnScene(this.v3_Pos);
        ...
        this.transform.position = v3_Pos_Transform;
    ...
    {
        this.v3_PosOnMatrix_Primary = v3_Pos;
    }

    public Vector3Int Get_PosOnMatrix_Primary()
    {
        return this.v3_PosOnMatrix_Primary;
    }
    ...
    {
        return Class_String.Get_String_Replace_Clone(this.name);
    }
    ...
    {
        this.cl_Block = cl_Imformation_Block;
    }
