...
public class IsoWorldRenderer : MonoBehaviour
{
    ...
    private void Set_Data_FromResources()
    {
        ...
        for (int i = 0; i < ls_Block_Ground.Count; i++) 
        {
            ...
            lg_Block_Ground[i] = 
                Class_Object.Get_Data_Application_Resource_List(ls_Block_Ground[i]);
        }
        ...
        for (int i = 0; i < ls_Block_Object.Count; i++)
        {
            ...
            lg_Block_Object[i] =
                Class_Object.Get_Data_Application_Resource_List(ls_Block_Object[i]);
        }
        ...
        for (int i = 0; i < ls_Block_Item.Count; i++)
        {
            ...
            lg_Block_Item[i] =
                Class_Object.Get_Data_Application_Resource_List(ls_Block_Item[i]);
        }
        ...
        for (int i = 0; i < ls_Block_StairUD.Count; i++)
        {
            ...
            lg_Block_StairUD[i] =
                Class_Object.Get_Data_Application_Resource_List(ls_Block_StairUD[i]);
        }
        ...
        for (int i = 0; i < ls_Block_StairLR.Count; i++)
        {
            ...
            lg_Block_StairLR[i] =
                Class_Object.Get_Data_Application_Resource_List(ls_Block_StairLR[i]);
        }
        ...
        for (int i = 0; i < ls_Character_Player.Count; i++)
        {
            ...
            lg_Character_Player[i] =
                Class_Object.Get_Data_Application_Resource_List(ls_Character_Player[i]);
        }
        ...
        for (int i = 0; i < ls_Character_Good.Count; i++)
        {
            ...
            lg_Character_Good[i] =
                Class_Object.Get_Data_Application_Resource_List(ls_Character_Good[i]);
        }
        ...
        for (int i = 0; i < ls_Character_Neutral.Count; i++)
        {
            ...
            lg_Character_Neutral[i] =
                Class_Object.Get_Data_Application_Resource_List(ls_Character_Neutral[i]);
        }
        ...
        for (int i = 0; i < ls_Character_Bad.Count; i++)
        {
            ...
            lg_Character_Bad[i] =
                Class_Object.Get_Data_Application_Resource_List(ls_Character_Bad[i]);
        }
    }
