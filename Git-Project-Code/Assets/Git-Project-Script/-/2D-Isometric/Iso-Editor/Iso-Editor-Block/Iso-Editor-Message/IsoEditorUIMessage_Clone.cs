...
public class IsoEditorUIMessageClone : MonoBehaviour
{
    [Tooltip("Button Fix")]
    //[SerializeField]
    ...
    public void SetClone(string s_Message_Name, string s_Message_Message)
    {
    ...
    {
        cl_Editor_Block_Message.Set_Fix(GetComponent<UIVerticalClone>().GetClone_Index());
    }

    public void Button_Copy()
    {
        cl_Editor_Block_Message.Set_Copy(GetComponent<UIVerticalClone>().GetClone_Index());
    }

    public void Button_Del()
    {
        cl_Editor_Block_Message.Set_Del(GetComponent<UIVerticalClone>().GetClone_Index());
    }
