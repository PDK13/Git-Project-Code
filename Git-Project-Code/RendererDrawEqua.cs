...
[RequireComponent(typeof(RendererDrawEquaPoint))]

//Script dùng để điều khiển việc vẽ trên Renderer
public class RendererDrawEqua : MonoBehaviour
{
    private RendererDrawEquaPoint cs_Point;
    ...
    private void Start()
    {
        cs_Point = GetComponent<RendererDrawEquaPoint>();
